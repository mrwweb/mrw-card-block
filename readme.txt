...
This plugin also adds support for the aspect ratio of the image. Since it is a block variation, uninstalling the plugin will just have the cards fall back to Media & Text blocks, preserving all content.
